...
public class MyProgressView extends View {
	...
	private void initAttrs(Context context, AttributeSet attrs) {
		...
		mRadius = typeArray.getDimension(R.styleable.MyProgressView_radius, 80);
		mStrokeWidth = typeArray.getDimension(
				R.styleable.MyProgressView_strokeWidth, 10);
		mCircleColor = typeArray.getColor(
				R.styleable.MyProgressView_circleColor, 0xFFFFFFFF);
		mRingColor = typeArray.getColor(R.styleable.MyProgressView_ringColor,
				0xFFFFFFFF);
