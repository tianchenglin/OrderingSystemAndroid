...
public class pop_select_desk_order implements View.OnClickListener {
	AdapterView.OnItemClickListener ItemClick = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> paramAnonymousAdapterView,
			...
			((DeskgridAdapter) pop_select_desk_order.this.listdesk.getAdapter())
	...
	AdapterView.OnItemClickListener deskItemClick = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> paramAnonymousAdapterView,
				View paramAnonymousView, int paramAnonymousInt,
				long paramAnonymousLong) {
			pop_select_desk_order.this.mtableid
	...
	public pop_select_desk_order(Context paramContext, View paramView , String state) {
		this.state = state;
