...
public class pop_selectdesk implements View.OnClickListener {
	AdapterView.OnItemClickListener ItemClick = new AdapterView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> paramAnonymousAdapterView,
			...
			((DeskgridAdapter) pop_selectdesk.this.listdesk.getAdapter())
	...
	public pop_selectdesk(Context paramContext, View paramView , String state) {
		this.state = state;
